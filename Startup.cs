...
namespace GloableCommunication
{
    public class Startup
    {
        ...
        {
            services.AddSession();
            services.AddDbContextPool<GCommunicationContext>(options =>
            options.UseSqlServer(Configuration.GetConnectionString("GCommunicationContext")));
